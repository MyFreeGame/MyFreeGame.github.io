...
(function () {
    ...
    var w = {
        zh: {
            ...
            GO_OUT_WECHAT_TIP: "<span class=\"span1\">\n" +
                "            <img src=\"//spic.dibaqu.com/images/click_btn.png\">\n" +
                "        </span>\n" +
                "        <span class=\"span2\">\n" +
                "            <em>1</em> 点击右上角\n" +
                "            <img src=\"//spic.dibaqu.com/images/menu_android.png\">\n" +
                "            打开菜单\n" +
                "        </span>\n" +
                "        <span class=\"span2 android_open\">\n" +
                "            <em>2</em> 选择\n" +
                "            <img src=\"//spic.dibaqu.com/images/android.png\">\n" +
                "        </span>",
            GO_OUT_WECHAT_IOS_TIP: "<span class=\"span1\">\n" +
                ...
                "        <span class=\"span2\">\n" +
                "            <em>1</em> 点击右上角\n" +
                "            <img src=\"//spic.dibaqu.com/images/menu.png\">\n" +
                "            打开菜单\n" +
                "        </span>\n" +
                "        <span class=\"span2\">\n" +
                "            <em>2</em> 选择\n" +
                "            <img src=\"//spic.dibaqu.com/images/safari.png\">\n" +
                "            用Safari打开下载\n" +
                "        </span>",
            FOOTER_SLOGAN: 'dibaqu.com 是应用内测平台，请自行甄别应用风险，<wbr />如应用存在问题，<wbr />可点击“举报”按钮 <a class="one-key-report" href="javascript:;">举报!</a>',
            SAFE: "安全",
            ...
            UNTRUSTED_ENTERPRISE_DEVELOPER: "<div style=\"text-align:center;padding:15px;\"><a target=\"_blank\" href=\"/guide.html\" style=\"color:#157df1;\"><span class=\"glyphicon glyphicon-hand-right\"></span>&nbsp;&nbsp;\"未受信任的企业级开发者\"的解决办法</a></div>",
            VERSION: "版本",
            SIZE: "大小",
            UPDATE_TIME: "更新时间",
            FOR_ANDROID: "适用于安卓手机",
            ...
            REALNAME_LAYER_CONTENT: "建议您：<br>尽快登录第八区网站，点击右上角未实名认证，进行认证。<br>未实名认证，下载链接有效期只有24小时，只能下载5次。",
            REALNAME_LAYER_BUTTON_TEXT: "知道了",
            BUTTON_OK: "确定",
            NOSIGN_TITLE: "安装提示",
            NOSIGN_MESSAGE: "文件下载完成，请点击“立即安装”",
            BUTTON_INSTALL: "立即安装",
            BUTTON_CANCEL: "取消",
            DISCLAIMER_TEXT: "<p style=\"padding-top:20px;link-height:10px;\">平台为第三方应用提供应用反馈收集等服务。应用内容均来源于第三方产品，仅为用户提供下载支持，不涉及任何人工编辑和整理，也不对任何来源于第三方的内容（包括但不限于安装包安全、信息描述、应用截图）承担责任，用户可根据描述场景谨慎选择下载试用。</p>\
                                <p style=\"padding-top:20px;link-height:10px;\">任何公司、产品或者个人认为平台涉嫌侵犯您的版权或应用权，您应该及时向我们提供举报声明、书面权利通知，并提供身份证明、权属证明及侵权情况等投诉材料。我们将依法进行处理。</p>\
                                <p style=\"padding-top:20px;link-height:10px;\">应用下载者与应用上传者如发生纠纷，请自行与上传者协商处理，协商无果请到相关部门进行投诉，或者拨打110警方介入，本平台不承担责任。</p>"
        },
        en: {
            ...
            UNTRUSTED_ENTERPRISE_DEVELOPER: "<div style=\"text-align:center;padding:15px;\"><a target=\"_blank\" href=\"/guide.html\" style=\"color:#157df1;\">Untrusted enterprise developer</a></div>",
            VERSION: "Version",
            SIZE: "Size",
            ...
            BUTTON_OK: "OK",
            NOSIGN_TITLE: "Installation Tips",
            NOSIGN_MESSAGE: "File download completed, please click “install",
            BUTTON_INSTALL: "INSTALL",
            BUTTON_CANCEL: "CANCEL",
            DISCLAIMER_TEXT: "<p style=\"padding-top:20px;link-height:10px;\">This platform provides application feedback collection and other services for third-party applications. The application content comes from the third-party products. It only provides download support for users, does not involve any manual editing and sorting, and does not assume responsibility for any content from the third party (including but not limited to installation package security, information description, application screenshot). Users can carefully choose to download and try according to the description scenario.</p>\
                            <p style=\"padding-top:20px;link-height:10px;\">If any company, product or individual believes that the platform is suspected of infringing your copyright or application rights, you should provide us with a report statement, written notice of rights, and provide us with identity certificate, ownership certificate, infringement and other complaint materials. We will deal with it according to law. </p>\
                            <p style=\"padding-top:20px;link-height:10px;\">In case of any dispute between the application downloader and the application uploader, please negotiate with the uploader on your own. If the negotiation fails, please go to the relevant department to complain, or call 110 police to intervene. The platform will not be responsible.。</p>"
        },
        "zh-tw": {
            ...
            FOOTER_SLOGAN: 'fir.im 是應用內測平台，請自行甄別應用風險，<wbr />如應用存在問題，<wbr />可點擊“舉報”按鈕 <a class="one-key-report" href="javascript:;">舉報!</a>',
            SAFE: "安全",
            ...
            BUTTON_OK: "確定",
            NOSIGN_TITLE: "安裝提示",
            NOSIGN_MESSAGE: "文件下載完成，請點擊“立即安裝”",
            BUTTON_INSTALL: "立即安裝",
            BUTTON_CANCEL: "取消",
            DISCLAIMER_TEXT: "<p style=\"padding-top:20px;link-height:10px;\">平臺為第三方應用提供應用反饋收集等服務。應用內容均來源於第三方產品，僅為用戶提供下載支持，不涉及任何人工編輯和整理，也不對任何來源於第三方的內容（包括但不限於安裝包安全、信息描述、應用截圖）承擔責任，用戶可根據描述場景謹慎選擇下載試用。</p>\
                               <p style=\"padding-top:20px;link-height:10px;\"> 任何公司、產品或者個人認為平臺涉嫌侵犯您的版權或應用權，您應該及時向我們提供舉報聲明、書面權利通知，並提供身份證明、權屬證明及侵權情況等投訴材料。我們將依法進行處理。</p>\
                                <p style=\"padding-top:20px;link-height:10px;\">應用下載者與應用上傳者如發生糾紛，請自行與上傳者協商處理，協商無果請到相關部門進行投訴，或者撥打110警方介入，本平臺不承擔責任。</p>"
        }
    };
    ...
    $(function () {
        window.DAFU = {
            brand: "dibaqu.com 3.1 - Rio",
            locale: 'zh',
            params: {},
            platform: {},
            config: {
                server: "https://www.dibaqu.com/jsonFormat"
            },
            data: {},
            APP: {},
            signPackage: {},
            ...
            init: function () {
                ...
                var weixin, isQQ = false;
                if (browser.versions.mobile) {//判断是否是移动设备打开。browser代码在下面
                     var ua = navigator.userAgent.toLowerCase();//获取判断用的对象
                    if (ua.match(/MicroMessenger/i) == "micromessenger") {
                        if (window.location.host == 'dibaqu.com') {
                            var url              = document.location.toString();
                            var arrUrl           = url.split(window.location.host + '/');
                            var para             = arrUrl[1];
                            //window.location.href = 'http://app.dibaquapp5.com/' + para;
                        }
                    }
                 }
            },
            query: function () {
                ...
                $.getJSON(this.config.server + '/' + this.getQuerySetting(), this.getQueryParams(), function (ret) {
                    ...
                    if (!self.APP.template) {
                        self.successVip();
                    } else if (['qipai2', 'buyu', 'majiang', 'qipai', 'tmp1', 'tmp2', 'tmp3', 'tmp4', 'tmp5', 'tmp6'].indexOf(self.APP.template) > -1) {
                        self.successVip();
            ...
            successVip: function () {
                ...
                if (hostname.indexOf('dibaqu.com') == -1) {
                    $('.template-footer .t-footer').hide();
                }

                var hostname = window.location.hostname;
                var ua = navigator.userAgent.toLowerCase();//获取判断用的对象
                if (hostname.indexOf('dibaquapp') !== -1 && ua.match(/MicroMessenger/i) == "micromessenger") {
                    $('title').html('请在Safari浏览器中打开');
                    $('.template-wrap').html('');
                }
                ...
                if (this.data.info.user.is_publish == 0 && this.data.info.source!=11) {
                    console.info(1);
                    Modal.templateModal({
            ...
            showAd: function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "https://dibaqu.com/show/adsense?template=" + this.APP.template,
            ...
            reportApp: function () {
                ...
                $(document).on('click', (".report .save"), function () {
                    ...
                    if (errorLength > 0) {
                        ...
                        $.post('https://dibaqu.com/show/report', {
                            email: email.val(),
            ...
            showPopup: function () {
                ...
                if (browser.versions.mobile) {//判断是否是移动设备打开。browser代码在下面
                    ...
                    if ($.ua.ua.match(/(iPhone|iPad|iPod|iOS|Macintosh; Intel Mac OS X)/i)) {
                        isiOS = true;
                    }
                ...
                if (appType == 'android' && isiOS) {
                    ...
                    $('.down_load').click(function () {
                        ...
                        $("#showtext").show();
                        if (isiOS && "ios" == appType) {
                            if(app_source != 3){
                                setTimeout(function () {
                                    $.ajax({
                                        type: "POST",
                                        url: "https://dibaqu.com/show/provision",
                                        data: {'id': DAFU.APP.url},
                                        dataType: 'json',
                                        beforeSend: function (xhr) {
                                        },
                                        success: function (result, textStatus, jqXHR) {
                                            var provision_url = result.data;
                                            $("#showtext").hide();
                                            var a = $("<a href='"+provision_url+"' class='ms-btn template-btn clearfix pc-pwd' style='display:block;background-color:#40acf1; border: 1px solid #40acf1;margin: 15px'>" + w[language].TRUST_DEVELOPER + "</a>");
                                            $("#showtext").after(a);
                                        },
                                        error: function (jqXHR, textStatus, errorThrown) {
                                        }
                                ...
                                Modal.generalModal({
                                    backdrop: true, // 点击阴影是否关闭弹窗， // true 开启； false 关闭
                                    iconClass: "",  // success: icon-modal-success1,  error: icon-modal-error2
                                    title: w[language].NOSIGN_TITLE,  // 弹窗标题
                                    p: w[language].NOSIGN_MESSAGE, // 弹窗内容
                                    align: 'left', // 弹窗内容排列顺序 left center right
                                    cancelBtnText: w[language].BUTTON_CANCEL,    // 取消按钮文字
                                    successBtnText: w[language].BUTTON_INSTALL,  // 确定按钮文字
                                    successBtnModal: true, // 点击确定按钮是否关闭弹窗 true 关闭 false 不关闭
                                    cancelBtnModal: true, // 点击取消按钮是否关闭弹窗 true 关闭 false 不关闭
                                    successCallback: function () {
            ...
            weixin: function () {
                ...
                wx.ready(function () {
                    wx.onMenuShareAppMessage({
                        ...
                        link: "https://dibaqu.com/" + this_app.url,
            ...
            submitPwd: function () {
                ...
                // 验证密码是否正确
                $.getJSON('https://dibaqu.com/show/check-password', {url: url, password: password}, function (data) {
                    if (data.code == 200) {
